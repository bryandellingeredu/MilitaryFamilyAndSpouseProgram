...
export default function Google({setPage}: Props){
    ...
    return(
       <>
        ...
        Google Calendar iCal Subscription Instructions
          <Header.Subheader>  Subscribing to the MSFP Calendar will automatically sync any changes made to your Google Calendar and you will receive updates automatically.
       </Header.Subheader>
        </Header.Content>
      </Header>
